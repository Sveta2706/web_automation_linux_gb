...
def test_step_3(site, select_input_login, select_input_password, select_input_button, new_post, select_post_title,
    ...
    click_1 = site.find_element('xpath', new_post) 
    click_1.click()
    post_1 = site.find_element('xpath', select_post_title)  
    post_1.send_keys(testdata['title'])
    post_2 = site.find_element('xpath', select_post_description)  
    post_2.send_keys(testdata['description'])
    click_2 = site.find_element('css', select_button_save)  
    click_2.click()

    time.sleep(4)

    post_ok = site.find_element('xpath', select_post_ok) 
